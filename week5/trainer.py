...
def fit(train_loader, val_loader, model, loss_fn, optimizer, scheduler, n_epochs, cuda, log_interval, model_id,
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        message = '\nEpoch: {}/{}.train_loss: {:.4f}, val_loss: {:.4f}'.format(epoch + 1, n_epochs,train_loss, val_loss)
...
def train_epoch(train_loader, model, loss_fn, optimizer, cuda, log_interval, metrics):
    ...
    for batch_idx, (data, target) in tqdm(enumerate(train_loader), desc='Epoch progress...'):
